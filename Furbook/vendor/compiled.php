...
class Carbon extends DateTime
{
    ...
    public static function setLocale($locale)
    {
        ...
        if (file_exists($filename = 'C:\\xampp\\htdocs\\Furbook\\vendor\\nesbot\\carbon\\src\\Carbon' . '/Lang/' . $locale . '.php')) {
...
class AppServiceProvider extends ServiceProvider
{
    public function boot()
    {
        $this->app['view']->composer('partials.forms.cat', 'Furbook\\Http\\Views\\Composers\\CatFormComposer');
    }
    public function register()
    {
        $this->app->bind('Illuminate\\Contracts\\Auth\\Registrar', 'Furbook\\Services\\Registrar');
    }
}
}
...
class BusServiceProvider extends ServiceProvider
{
    public function boot(Dispatcher $dispatcher)
    {
        $dispatcher->mapUsing(function ($command) {
            return Dispatcher::simpleMapping($command, 'Furbook\\Commands', 'Furbook\\Handlers\\Commands');
        });
    }
    public function register()
    {
